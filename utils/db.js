...
db.prepare("CREATE TABLE IF NOT EXISTS 'nickHistory' ('x' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 'usr' TEXT NOT NULL, 'srv' TEXT NOT NULL, 'val' TEXT NOT NULL);").run();
